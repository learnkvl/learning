...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        #Create instance to score game statistics and score
    ...
    def _check_play_button(self,mouse_pos):
        """start a new game whwn the player clicks play"""
    ...
    def _change_fleet_direction(self):
        """drop the entire fleet and changes the fleets direction"""
        for alien in self.aliens.sprites():
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
           #decrement ships left ,update the score board
    ...
    def _check_aliens_bottom(self):
        """check if any aliens have found""" 
